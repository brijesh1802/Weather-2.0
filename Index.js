...
async function weather() {
    try {
        ...
        if (!response.ok || !data.location) {
            ...
            document.querySelector(".weather").innerHTML = data.current.weather_descriptions;
            document.querySelector(".weatheri").innerHTML = data.current.weather_icons;
